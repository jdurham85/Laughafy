...
/********* Needs to create a folder named 'userfiles' and give permission '777' *********/
$Config['UserFilesPath'] = dirname(dirname(dirname(dirname(dirname(dirname(dirname($_SERVER['PHP_SELF']))))))).'userfiles/files/' ;
